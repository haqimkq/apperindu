                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <div class="ms-auto position-relative">
                                                ...
                                                <input type="text" name="username" class="form-control radius-30 ps-5" id="username" placeholder="Username anda">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            ...
                                            <div class="ms-auto position-relative">
                                                ...
                                                <input type="password" class="form-control radius-30 ps-5" id="password" name="password" placeholder="Password anda">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button type="submit" class="btn btn-primary radius-30 login">LOGIN</button>
                                            </div>
                                        </div>
