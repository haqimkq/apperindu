    ...
    <div class="row">
        <div class="col-md-12">
            <form action="" method="POST" autocomplete="off" class="form-update" enctype="multipart/form-data">
                ...
                <input type="hidden" name="tblizinpendaftaran_id" id="tblizinpendaftaran_id" value="<?= isset($id) ? $id : '' ?>">
                <?= csrf_field() ?>
                <div class="card mb-5">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="tblizinpendaftaran_idpemohon" id="tblizinpendaftaran_idpemohon" required>
                                </div>
                            </div>
                            <div class="col-md-6 col-12 mb-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="tblizinpendaftaran_almtpemohon" id="tblizinpendaftaran_almtpemohon" class="form-control" rows="2" required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="tblizinpendaftaran_npwp" id="tblizinpendaftaran_npwp" required>
                                </div>
                            </div>
                            <div class="col-md-6 col-12 mb-3">
                                <div class="form-group">
                                    <label for="" class="mb-1">Nomor Telepon</label>
                                    <input type="tel" class="form-control" name="tblizinpendaftaran_telponpemohon" id="tblizinpendaftaran_telponpemohon" required>
                                </div>
                            </div>
                            <div class="col-md-6 col-12 mb-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <select name="tblkecamatan_id" id="tblkecamatan_id" class="form-control single-select" required>
                                        <option value=""></option>
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <select name="tblkelurahan_id" id="tblkelurahan_id" class="form-control single-select" required>
                                        <option value=""></option>
                            ...
                            <div class="col-md-6 col-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="tblizinpendaftaran_keterangan" id="tblizinpendaftaran_keterangan" class="form-control" rows="2" required></textarea>
                                </div>
                            </div>
