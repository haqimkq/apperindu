                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12 mb-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="redaksi_diterima" id="redaksi_diterima" class="form-control"
                                        cols="30" rows="10"><?= $r['redaksi_diterima'] ?></textarea>
                            ...
                            <div class="col-md-12 col-12 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="wa_testing" id="wa_testing"
                                        value="<?= $r['wa_testing'] ?>" required>
