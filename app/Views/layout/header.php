            ...
            <ul class="navbar-nav align-items-center">
                        ...
                        <div class="header-message-list p-2">
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="<?= base_url() ?>assets/images/avatars/avatar-1.png" alt=""
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="<?= base_url() ?>assets/images/avatars/avatar-2.png" alt=""
                                        class="rounded-circle" width="50" height="50" />
                                    <div class="ms-3 flex-grow-1">
                                        <h6 class="mb-0 dropdown-msg-user">
                                            Althea Cabardo
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="<?= base_url() ?>assets/images/avatars/avatar-3.png" alt=""
                                        class="rounded-circle" width="50" height="50" />
                                    <div class="ms-3 flex-grow-1">
                                        <h6 class="mb-0 dropdown-msg-user">
                                            Katherine Pechon
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="<?= base_url() ?>assets/images/avatars/avatar-4.png" alt=""
                                        class="rounded-circle" width="50" height="50" />
                                    <div class="ms-3 flex-grow-1">
                                        <h6 class="mb-0 dropdown-msg-user">
                                            Peter Costanzo
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="<?= base_url() ?>assets/images/avatars/avatar-5.png" alt=""
                                        class="rounded-circle" width="50" height="50" />
                                    <div class="ms-3 flex-grow-1">
                                        <h6 class="mb-0 dropdown-msg-user">
                                            Thomas Wheeler
                            ...
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="<?= base_url() ?>assets/images/avatars/avatar-6.png" alt=""
                                        class="rounded-circle" width="50" height="50" />
                                    <div class="ms-3 flex-grow-1">
                                        <h6 class="mb-0 dropdown-msg-user">
                                            Johnny Seitz
                ...
                <li class="nav-item dropdown dropdown-user-setting">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            <a class="dropdown-item" href="<?= site_url('pengguna/logout') ?>">
                                <div class="d-flex align-items-center">
