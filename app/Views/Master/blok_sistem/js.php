...
function update(id) {
    ...
    var input = ['tblkendalibloksistem_nama'];
    let select = ['tblkendalibloksistem_isaktif'];
...
function lihat_blok_sistem_tugas(id) {
    $('#bloksistemtugas-modal').modal('show');
    ...
    $.ajax({
        ...
        type: "POST",
        dataType: 'html',
        url: "<?= site_url($path . '/get_blok_sistem') ?>",
        success: function(response) {
...
function lihat_pengguna(id) {
    ...
    $.ajax({
        ...
        type: "POST",
        dataType: 'html',
        url: "<?= site_url($path . '/get_pengguna') ?>",
        success: function(response) {
            $('.content').html(response)
        }
    });
