                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-12 mb-3">
                            <div class="form-group">
                                <label for="" class="mb-1">ID Kecamatan</label>
                                <input type="number" class="form-control" name="tblkecamatan_id" id="tblkecamatan_id">
                            </div>
                        </div> -->
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tblkecamatan_nama" id="tblkecamatan_nama"
                                    required>
                            </div>
                        </div>
                    </div>
