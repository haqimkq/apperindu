                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control mb-2" name="tblskizin_rekomtemplate"
                                        id="tblskizin_rekomtemplate">
                                    <input type="hidden" name="tblskizin_rekomtemplate_old"
                                        id="tblskizin_rekomtemplate_old">
                                    <a href="" id="link" target="_blank" class="mt-2">Template sebelumnya</a>
