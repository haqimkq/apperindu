                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="tblizinpersyaratan_urut"
                                    id="tblizinpersyaratan_urut" required>
                            </div>
                        </div>
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                <label for="" class="mb-1">Nama Persyaratan</label>
                                <select name="tblpersyaratan_id" id="tblpersyaratan_id"
                                    class="form-control single-select" required>
                                    <option value="">Pilih</option>
                                    <?php foreach ($persyaratan as $r) : ?>
                                    <option value="<?= $r['tblpersyaratan_id'] ?>">
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <select name="tblizinpersyaratan_isaktif" id="tblizinpersyaratan_isaktif"
                                    class="form-control">
